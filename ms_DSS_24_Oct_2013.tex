...
\begin{figure*}
  ...
  \includegraphics[width=0.49\textwidth]{../plots/10/09/fbon-flux-contour-low.pdf}
  \hfill
  \includegraphics[width=0.49\textwidth]{../plots/10/09/fbon-flux-contour-high.pdf}
...
\begin{figure}
  \centering
  % from plot_1chan_2d() in structure/python/rc.py
  \includegraphics[width=1.0\columnwidth]{../plots/10/09/fbon-k-contour.pdf}
...
\begin{figure*}
  \centering
% from plot_1chan_2d() in structure/python/rc.py
\includegraphics[width=0.32\textwidth]{../plots/10/09/flux-k-contour-fbon-0p2.pdf}
\hfill
\includegraphics[width=0.32\textwidth]{../plots/10/09/flux-k-contour-fbon-0p7.pdf}
\hfill
\includegraphics[width=0.32\textwidth]{../plots/10/09/flux-k-contour-fbon-0p9.pdf}
...
\includegraphics[width=0.45\textwidth]{../plots/10/09/grav-1chan-fbon-0p5-k-0p1.pdf}
\includegraphics[width=0.45\textwidth]{../plots/10/09/grav-1chan-fbon-0p5-k-10.pdf}
...
\begin{figure}
% from plot_grav_1chan() in structure/python/rc.py
\includegraphics[width=0.45\textwidth]{../plots/10/09/grav-1chan-fbon-0p2-k-0p1.pdf}
\caption{Contours of surface gravity as a function of effective
  temperature of external radiation (x axis) and effective temperature
